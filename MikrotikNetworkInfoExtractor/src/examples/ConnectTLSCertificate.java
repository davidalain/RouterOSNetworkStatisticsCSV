...
public class ConnectTLSCertificate {
    ...
    protected void connect() throws Exception {
        con = ApiConnection.connect(SSLSocketFactory.getDefault(), InputKeyboardUtil.getHost(), ApiConnection.DEFAULT_TLS_PORT, ApiConnection.DEFAULT_CONNECTION_TIMEOUT);
