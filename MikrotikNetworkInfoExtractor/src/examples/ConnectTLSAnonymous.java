...
public class ConnectTLSAnonymous {
    ...
    protected void connect() throws Exception {
        con = ApiConnection.connect(AnonymousSocketFactory.getDefault(), InputKeyboardUtil.getHost(), ApiConnection.DEFAULT_TLS_PORT, ApiConnection.DEFAULT_CONNECTION_TIMEOUT);
